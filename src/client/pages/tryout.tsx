                            ...
                            <div className="mt-8 grid grid-cols-12 pr-20">
                                ...
                                <div className="col-span-11">
                                    <div className="">
                                        ...
                                        adipiscing elit. Donec feugiat odio
                                        feugiat, mattis libero vitae, porttitor
                                        mi. Sed nec elit ex. Donec mattis,
                                        turpis id interdum feugiat, augue dolor
                                        vulputate ipsum, in porta lorem nulla ut
                                        justo. Nunc eget pellentesque tortor,
                                        sed ornare sapien. Curabitur semper
                                        mauris quis tellus mollis, vitae
                                        imperdiet quam sodales. Nunc ultrices
                                        maximus orci in lacinia. Interdum et
